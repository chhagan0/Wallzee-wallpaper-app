...
class WallpaperRecyclerAdapter(
    var context: Context?,
    private val wallpaperList: ArrayList<WallpaperDataClass>
) : RecyclerView.Adapter<WallpaperRecyclerAdapter.ViewHolder>() {
...
//            .diskCacheStrategy(DiskCacheStrategy.AUTOMATIC)
        ...
        holder.tvWallpaperName.text = currentItem.imageUrl
//
//        //animation
        holder.cv.animation =
